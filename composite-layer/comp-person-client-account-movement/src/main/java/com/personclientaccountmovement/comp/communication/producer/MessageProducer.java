package com.personclientaccountmovement.comp.communication.producer;

import org.springframework.beans.factory.BeanFactory;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

import com.personclientaccountmovement.comp.config.PersonClientAccountMovementAppConfig;
...
public class MessageProducer implements IGenericProducer {
    ...
    @Autowired
    private PersonClientAccountMovementAppConfig config;   
...
*/
    ...
    public <P, R> R process(GenericProducerModel<P> request) throws GenericException {
        ...
        try {
            ...
            log.error("[composite MessageProducer] Fallo option={} service={} type={} transactionId={}",
